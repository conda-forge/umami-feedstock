About umami-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/umami-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/TerrainBento/umami
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7706&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/umami-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `umami` can be installed with `conda`:
...
It is possible to list all of the versions of `umami` available on your platform with `conda`:
...
```
mamba search umami --channel conda-forge
```
...
mamba repoquery search umami --channel conda-forge

# List packages depending on `umami`:
mamba repoquery whoneeds umami --channel conda-forge

# List dependencies of `umami`:
mamba repoquery depends umami --channel conda-forge
```
